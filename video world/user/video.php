		...
		<div class="video1 text-center" style="width:100%;">
			...
			<div class="row" style="padding:10px;">
				<div class="col-md-12 video_title">
					...
					<h6 class="pull-right" style="color:grey;"><?php if($num>0){ ?><span class="fa fa-thumbs-up" style="font-size:20px;"></span>Liked<?php }else{ ?><a href="#" id="like" class="like" name="<?php echo $arr_video['id'];?>" data-toggle="tooltip" title="LIKE"><span class="fa fa-thumbs-up" style="font-size:20px;"></span>Like</a>
						<a href="#" id="unlike" class="like" name="<?php echo $arr_video['id'];?>" data-toggle="tooltip" title="UNLIKE"><span class="fa fa-thumbs-down" style="font-size:20px;"></span>Unlike </a><?php } ?>

								<?php if (isset($wid)) {?>
								<a href="remove_watch_letter.php?vid=<?php echo $vid?>" data-toggle="tooltip" title="RMOVE WATCH LATER"><span class="fa fa-minus" style="font-size: 20px;"></a>
								<?php }else{?>
								...
								<?php }?> 
								<a href="download.php"  data-toggle="tooltip" title="DOWNLOAD"><span class="fa fa-cloud-download" style="font-size: 20px;"></span></a>
