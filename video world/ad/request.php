						...
						<div class="col-sm-12">
								...
								<div class="ibox">
									<div class="ibox-heading">
										<h3>List of all rectors/warden Request &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<i class="fa fa-bell"><a href="#"></a></i>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<i class="fa fa-envelope"><a href="#"></a></i></h3>
			...
			<form enctype="multipart/form-data" action="">
					...
					<div class="col-sm-offset-5 col-sm-7">
						<input type="submit" value="<?php if(isset($_GET['id'])){echo "Update";}else{echo "Search";}?>"  name="<?php if(isset($_GET['id'])){echo "update";}else{echo "Upload";}?>" />
										...
										?>	
											<tr>
												...
												<td><form action="demo_form.asp">
  													<input type="checkbox" name="vehicle" value="Bike" style="size:50%"></form>
  													</td>
											</tr>
											<?php
												}
							...
							<div class="col-sm-offset-5 col-sm-7">
						<input type="submit" value="<?php if(isset($_GET['id'])){echo "Update";}else{echo "send";}?>"  name="<?php if(isset($_GET['id'])){echo "update";}else{echo "send";}?>" />
